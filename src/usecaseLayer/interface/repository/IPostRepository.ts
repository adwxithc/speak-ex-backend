...
export interface IPostRepository {
    ...
    downvote({postId,userId}:{postId:string, userId:string}):Promise<IPost | null>
    insertComment({postId,commentId}:{postId:string; commentId:string}):Promise<IPost | null>
    removeComment({postId,commentId}:{postId:string, commentId:string}):Promise<boolean>
}
