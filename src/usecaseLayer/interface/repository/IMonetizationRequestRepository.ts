...
export interface IMonetizationRequestRepository {
    ...
    listMonetizationRequests({limit,page,status}:{limit:number,page:number,status: IMonetizationRequestStatus | 'all'}):Promise<{requests: IMonetizationRequestData[];totalRequests: number;}>
}